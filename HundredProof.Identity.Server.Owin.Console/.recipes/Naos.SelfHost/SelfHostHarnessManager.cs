...
namespace HundredProof.Identity.Server.Owin.Console
{
    ...
    public class SelfHostHarnessManager
    {
        ...
        public static void Configuration(Microsoft.AspNetCore.Builder.IApplicationBuilder app)
        {
            app
        ...
        private static HttpConfiguration BuildHttpConfiguration(HostingSettings hostingSettings, ExceptionLogger exceptionLogger, HttpConfiguration httpConfiguration)
        {
            ...
            */
            ...
            if (hostingSettings?.Cors != null && hostingSettings.Cors.Origins.Any())
            {
                ...
                if (cors.PreflightMaxAge != default(TimeSpan))
                {
                    corsPolicyProvider.PreflightMaxAge = (long)cors.PreflightMaxAge.TotalSeconds;
                }
